...
<template>
  <div class="min-h-screen bg-[#0F1117] text-white p-6 max-w-6xl mx-auto font-sans">
    <h1 class="text-4xl font-bold mb-8 text-primary">Historique des Trades</h1>
    ...
    <div class="flex flex-col md:flex-row md:items-center gap-4 mb-8">
      <input
        ...
        class="p-3 rounded-md bg-gray-900 text-white placeholder-gray-400 border border-gray-700 focus:outline-none focus:ring-2 focus:ring-primary w-full md:w-1/3"
      />
      <input
      ...
      <button
        @click="resetFilters"
        class="px-5 py-3 rounded-md bg-primary text-black font-semibold hover:bg-opacity-90 transition"
      >
        Réinitialiser
      </button>
    </div>
    ...
    <div class="overflow-x-auto">
      <table class="w-full text-sm text-left border border-gray-800 rounded-lg overflow-hidden">
        <thead class="bg-[#1a1c22] text-primary uppercase text-xs">
          <tr>
