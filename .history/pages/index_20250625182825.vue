<template>
  <div class="p-6 max-w-xl mx-auto">
    ...
    <form @submit.prevent="submitTrade" class="space-y-4">
      <input v-model="trade.asset" placeholder="Actif" class="w-full p-2 border rounded" />
      ...
      <input v-model="trade.result" placeholder="Résultat" class="w-full p-2 border rounded" />
      <input v-model="trade.strategy" placeholder="Stratégie" class="w-full p-2 border rounded" />
      <textarea v-model="trade.comment" placeholder="Commentaire" class="w-full p-2 border rounded"></textarea>
