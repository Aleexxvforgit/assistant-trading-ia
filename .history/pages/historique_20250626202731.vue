...
<template>
  <div class="min-h-screen bg-[#0F1117] text-white p-6 max-w-6xl mx-auto font-sans">
    <h1 class="text-4xl font-bold mb-8 text-[rgb(28, 78, 218)]">Historique des Trades</h1>
    ...
    <div class="flex flex-col md:flex-row md:items-center gap-4 mb-8">
      ...
      <button
        @click="resetFilters"
        class="px-5 py-3 rounded-md bg-[#0084ff] text-black font-semibold hover:bg-opacity-90 transition"
      >
        Réinitialiser
      </button>
    </div>
